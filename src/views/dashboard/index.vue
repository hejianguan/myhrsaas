<template>
  <div class="dashboard-container">
      ...
      <div>
        <div class="fl headL">
          ...
          <div class="headInfoTip">
            <p class="firstChild">嘿!{{ userInfo.username }}，你终于醒了!</p>
    ...
    <!-- 放置一个离职弹层 -->
    <el-dialog title="离职申请" :visible="showDialog" @close="btnCancel">
      <el-form ref="myForm" :model="formData" :rules="rules" label-width="120px">
        <el-form-item label="离职时间" prop="exceptTime">
          <el-date-picker v-model="formData.exceptTime" />
        </el-form-item>
...
// userInfo是vuex的子模块的数据
const { mapState } = createNamespacedHelpers('user') // 单独某个子模块的辅助函数
